<div class="w-full h-7 bg-gray-900 flex">
	<div
		class="h-full flex w-fit px-4  place-items-center text-white gap-2 border-[1px] border-gray-900 border-b-pink-400"
	>
		...
		<h3 class="font-code text-xl">app.ts</h3>
		<svg
	...
	<div
		class="bg-gray-700 h-full flex w-fit px-4  place-items-center text-white gap-2 border-[1px] border-gray-900"
	>
		<svg viewBox="0 0 128 128" class="w-6 h-6">
			<path
				fill="#007acc"
		...
		<h3 class="font-code text-xl">tsconfig.json</h3>
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			fill="none"
	...
	>
		...
		<h3 class="font-code text-xl">package.json</h3>
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			fill="none"
